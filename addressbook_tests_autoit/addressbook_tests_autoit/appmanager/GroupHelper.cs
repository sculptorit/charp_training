...
namespace addressbook_tests_autoit
{
    public class GroupHelper : HelperBase
    {
        ...
        public GroupHelper Remove(int t)
        {
            OpenGroupsDialogue();
        ...
        public void CheckGroupPresence(GroupData group)
        {
            OpenGroupsDialogue();

            if (int.Parse(aux.ControlTreeView(GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51"
                , "GetItemCount", "#0", "")) <= 1)
            {
                CloseGroupsDialogue();
                Add(group);
